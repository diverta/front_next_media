  ...
  return (
    ...
    <footer className="l-footer">
      <div className="l-container--large">
          ...
          <ul className="l-footer__nav__list -sns">
            ...
            <li>
              <Link
                ...
                aria-label="X"
                >
                <svg width="19" height="24" viewBox="0 0 1200 1227" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
        ...
        <p className="l-footer__copyright">© 2023 CompanyName Inc. All Rights Reserved.</p>
      </div>
    </footer>

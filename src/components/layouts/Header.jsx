        ...
        <nav className="l-header__nav">
          ...
          <div className="l-header__nav__inner">
            <ul className="l-header__nav__list">
              <li className="l-header__nav__list__item"><a href="/article/">FOOD</a></li>
              <li className="l-header__nav__list__item"><a href="/article/">SHOPPING</a></li>
              <li className="l-header__nav__list__item"><a href="/article/">SIGHTSEEING</a></li>
              <li className="l-header__nav__list__item"><a href="/article/">EVENT</a></li>
              <li className="l-header__nav__list__item"><a href="/article/">CULTURE</a></li>
            </ul>
            ...
            <div className="l-header__nav__options">
              {/* 未ログイン
              <a href="/login/" className="l-header__nav__options__button u-display-flex u-display-flex-align-items-center">
              ログイン
              ...
              <a href="/member/regist/" className="l-header__nav__options__button c-button -regist">会員登録</a>
              */}
              
              {/* ログイン時 */}
              <p className="is-sp c-text--small u-mt-0">ようこそ！クロコさん</p>
              <a href="/member/mypage/" className="l-header__nav__options__button c-button">マイページ</a
              >
              <button
                type="button"
